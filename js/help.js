var HELP_PAGES = [
  {
    ...
    sections: [
      ...
      ["座標快捷按鈕", "貼上座標輸入框下方有重新輸入、分析地址與區域、快速新增三個按鈕，可快速完成常用操作。"],
      ["快速新增", "功能和下方「新增到紀錄」相同，適合資料已填好時直接存入紀錄。"],
      ["國家", "選擇座標所在國家。目前支援台灣、日本、韓國、香港、越南與其他。"],
      ["自動判斷國家", "系統會依座標輔助判斷國家；按分析地址與區域後，國家選單也會自動切到台灣、越南、日本、韓國或香港。"],
    ...
    tip: "新增跨國座標時，可先按分析地址與區域，確認國家自動切換正確後再新增。"
  },
  {
    id: "view",
    icon: "🌼",
